...
const main = async () => {
    ...
    const daiETHPriceFeed = await getDAIPrice()
    console.log("daiETHPriceFeed", daiETHPriceFeed)
    const daiETHPrice = await daiETHPriceFeed.latestRoundData()
